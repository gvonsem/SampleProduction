...
# with command line options: Configuration/GenProduction/python/sherpa_ttbar_jetsNLO_MASTER_cff.py --fileout file:sherpa_ttbar_jetsNLO.root --mc --eventcontent RAWSIM --datatier GEN --conditions 106X_mc2017_realistic_v6 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN --geometry DB:Extended --era Run2_2017
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/sherpa_ttbar_jetsNLO_MASTER_cff.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:sherpa_ttbar_jetsNLO.root'),
