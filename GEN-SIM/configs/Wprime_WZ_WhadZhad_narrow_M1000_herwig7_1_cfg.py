...
# with command line options: Configuration/GenProduction/python/Wprime_WZ_WhadZhad_narrow_M1000_herwig7-fragment.py --fileout file:Wprime_WZ_WhadZhad_narrow_M1000_herwig7.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --nThreads 4 --geometry DB:Extended --era Run2_2017 --python_filename Wprime_WZ_WhadZhad_narrow_M1000_herwig7_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Wprime_WZ_WhadZhad_narrow_M1000_herwig7-fragment.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Wprime_WZ_WhadZhad_narrow_M1000_herwig7.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Wprime_WZ_WhadZhad_narrow_M1000_herwig7_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.4.2/exo_diboson/Spin-1/Wprime_WZ_WhadZhad/narrow/Wprime_WZ_WhadZhad_narrow_M1000_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
