...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Wprime_WZ_WhadZhad_narrow_M3000_herwig7-fragment.py nevts:10'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.4.2/exo_diboson/Spin-1/Wprime_WZ_WhadZhad/narrow/Wprime_WZ_WhadZhad_narrow_M3000_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
