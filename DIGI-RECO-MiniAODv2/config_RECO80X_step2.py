...
# with command line options: step2 --filein file:B2G-RunIISpring16DR80-00005_step1.root --fileout file:B2G-RunIISpring16DR80-00005.root --mc --eventcontent AODSIM,DQM --runUnscheduled --datatier AODSIM,DQMIO --conditions 80X_mcRun2_asymptotic_v14 --step RAW2DIGI,RECO,EI,DQM:DQMOfflinePOGMC --era Run2_2016 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:B2G-RunIISpring16DR80-00005_step1.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIISpring16DR80-00005.root'),
